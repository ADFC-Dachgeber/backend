...
export class AccountsService {
  ...
  async create(data: { description: string, location: [number, number] }): Promise<Account> {
  ...
  async allWithDescriptionAndCoord():
    Promise<ReadonlyArray<Account & { description: Description, location: Location }>> {
